...
\item Ist $X$ einfach irgendeine Menge ohne geometrische oder irgendeine andere Struktur, dann bezeichnet man mit $\Sym(X)$ die \udot{symmetrische Gruppe auf/von $X$}. Dass die Menge unstrukturiert ist, bedeutet, dass wir einfach \emph{alle} Abbildungen $X\to X$ betrachten, d.h.
