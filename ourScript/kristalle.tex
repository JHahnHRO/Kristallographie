...
\begin{definition}
Es sei $\Lambda$ ein Kristall.

Wählen wir drei unabhängige $v_1,v_2,v_3\in Trans(\Lambda)$, dann nennt man den Parallelepiped
\[Z:=\Set{\lambda_1 v_1 + \lambda_2 v_2 + \lambda_3 v_3 | 0\leq \lambda_i \leq 1}\]
